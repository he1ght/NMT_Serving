...
class MTS:
    ...
    def main(self, cfg: DictConfig):
        ...
        if cfg.common_eval.results_path is not None:
            ...
            with open(output_path, "w", buffering=1, encoding="utf-8") as h:
                return self._main(cfg, h)
        else:
            return self._main(cfg, sys.stdout)
    ...
    def _main(self, cfg: DictConfig, output_file):
        logging.basicConfig(
        ...
        for sample in progress:
            print(sample.keys())
            sample['id'] = sample['id'][0]
            print(sample['id'])
            # sample['nsentences'] = sample['nsentences'][0]
            print(sample['nsentences'])
            # sample['ntokens'] = sample['ntokens'][0]
            print(sample['ntokens'])
            # sample['net_input'] = sample['net_input'][0]
